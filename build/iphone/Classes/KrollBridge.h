...
@interface RegionsLocatorObject : KrollCoverageObject {
#else
@interface RegionsLocatorObject : KrollObject {
#endif
@private
...
extern NSString * RegionsLocator$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	RegionsLocatorObject *_regionslocator;
    KrollObject* console;
	BOOL shutdown;
