...
/**
 Base class for all RegionsLocator views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RegionsLocator view hierarchy (such as wrapped iOS UIViews) was touched.
