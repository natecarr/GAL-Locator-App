...
//@interface RegionsLocatorObject : NSObject
//@end

@interface RegionsLocatorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RegionsLocatorObject class]])
		{
			for (NSString *key in [[(RegionsLocatorObject*)o modules] allKeys])
			{
