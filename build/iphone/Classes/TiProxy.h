...
//Rare exceptions to indicate a bug in the _regionslocator code (Eg, function that a subclass should have implemented)
...
/**
 The base class for RegionsLocator proxies.
 */
