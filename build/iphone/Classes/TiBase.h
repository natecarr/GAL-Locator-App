...
// in simulator we redefine to format for RegionsLocator Developer console
...
{\
	NSString * exceptionName = [@"org.regionslocator." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.regionslocator";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRegionsLocatorNativeItemNone = -1, 
	UIRegionsLocatorNativeItemSpinner = -2,
	UIRegionsLocatorNativeItemProgressBar = -3,
	
	UIRegionsLocatorNativeItemSlider = -4,
	UIRegionsLocatorNativeItemSwitch = -5,
	UIRegionsLocatorNativeItemMultiButton = -6,
	UIRegionsLocatorNativeItemSegmented = -7,
	
	UIRegionsLocatorNativeItemTextView = -8,
	UIRegionsLocatorNativeItemTextField = -9,
	UIRegionsLocatorNativeItemSearchBar = -10,
	
	UIRegionsLocatorNativeItemPicker = -11,
	UIRegionsLocatorNativeItemDatePicker = -12,
	
	UIRegionsLocatorNativeItemInfoLight = -13,
	UIRegionsLocatorNativeItemInfoDark = -14,
	
	UIRegionsLocatorNativeItemDisclosure = -15,
	
	UIRegionsLocatorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RegionsLocator instances of
